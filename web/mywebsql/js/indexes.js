/**********************************************************
 *  indexes.js - Author: Samnan ur Rehman                 *
 *  This file is a part of MyWebSQL package               *
 *  collection of functions to help with index editing    *
 **********************************************************/
...
function selectIndex() {
	...
	$('#chk_primary').attr('checked', primary);
	$('#chk_unique').attr('checked', unique);
	$('#chk_fulltext').attr('checked', fulltext);
