/**********************************************************
 *  users.js - Author: Samnan ur Rehman                   *
 *  This file is a part of MyWebSQL package               *
 *  collection of functions to help with user management  *
 **********************************************************/
...
function showDbPrivileges() {
	...
	$('#selectall').attr('checked', $('#tab-db .dbprv').not(':checked').length == 0);
}
...
function updateUser() {
	...
	password = $('#userpass').val();	
	password2 = $('#userpass2').val();
	removepass = $('#nopass').attr('checked') ? '1' : '0';
