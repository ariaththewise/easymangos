	...
	<ul id="main-menu" class="dropdown">
		<li>
			...
			<ul>
				...
				<li class="db option mysql4 mysql5 mysqli"><a class="iexpdb" href="javascript:dataExport()" title="<?php echo __('Export database to external file'); ?>"><?php echo __('Export'); ?>...</a></li>
			</ul>
		</li>
		<li class="db">
		...
		<li>
			...
			<ul>
				<li class="option mysql4 mysql5 mysqli"><a class="iimprt" href="javascript:dataImport()" title="<?php echo __('Import multiple queries from batch file'); ?>"><?php echo __('Import batch file'); ?>...</a></li>
				<li class="db option mysql4 mysql5 mysqli"><a class="iexpdb" href="javascript:dataExport()" title="<?php echo __('Export database to batch file as sql dump'); ?>"><?php echo __('Export database'); ?>...</a></li>
		...
		<li>
			...
			<ul>
				...
				<li class="option mysql4 mysql5 mysqli"><a class="itchk" href="javascript:toolsDbCheck()" title="<?php echo __('Analyze and repair database tables'); ?>"><?php echo __('Repair Tables'); ?></a></li>
				<li><a class="itsrch" href="javascript:toolsDbSearch()" title="<?php echo __('Search for text in the database'); ?>"><?php echo __('Search in Database'); ?></a></li>
			</ul>
		</li>
