<?php
	...
	***************************************************************/
	...
	function createErrorGrid(&$db, $query='', $numQueries=0, $affectedRows=-1) {
		...
		print "</div></td></tr>";
		print "<tr><td>";
		print "<div class=\"warning\">".__('Error occurred while executing the query').":</div><div class=\"sql_error\">".$formatted_query."</div><div class=\"message\">".htmlspecialchars($e)."</div>";
		print "</td></tr>";
		print "</table></div>";
	...
	function startForm($style="margin:0px;overflow:hidden;width:100%;height:100%") {
		...
		print '<div><span><img src="themes/'.THEME_PATH.'/images/loading.gif" /></div>';
		print '</div>';
